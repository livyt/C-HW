...
int armPosition = 0;
int score = 0;
bool robotState::hasPiece() const { return piece; }
int robotState::getPosition() const { return position; }
int robotState::getArmPosition() const { return armPosition; }
int robotState::getScore() const { return score; }
